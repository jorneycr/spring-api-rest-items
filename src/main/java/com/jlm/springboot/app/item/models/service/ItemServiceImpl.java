...
public class ItemServiceImpl implements ItemService {
	...
	public List<Item> findAll() {
		List<Producto> productos = Arrays
				.asList(clienteRest.getForObject("http://localhost:8080/productos", Producto[].class));
	...
	public Item finById(Long id, Integer cantidad) {
		...
		Producto producto = clienteRest.getForObject("http://localhost:8080/producto/{id}", Producto.class,
				pathVariables);
